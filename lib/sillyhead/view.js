...
function viewFor(state, viewerId) {
  ...
  return {
    ...
    // What just happened in the middle: who played, who picked the pile up,
    // whether it was sacked. All of it public — the room watched every card in
    // it go down — and it is here so the screens can show the move travelling
    // rather than the pile simply changing. Absent on a game saved before it
    // existed, which is why it is written as a fallback rather than assumed.
