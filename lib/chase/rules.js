...
/** Does this hand still hold a pair? Only ever true if something forgot to discard. */
function hasPair(hand) {
  return extractPairs(hand).pairs.length > 0;
}
...
module.exports = { extractPairs, hasPair, moveCard, insertAt, shuffleHand };
